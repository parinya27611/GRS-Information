			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div style="padding-top: 15px; padding-right: 18px;" align="right">
						<a  href="add_login.php"><button type="submit" class="btn btn-primary">+ ADD NEW</button></a>
					</div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        	<input type="password" class="form-control" name="log_password" required="required" readonly
											value="<?php  echo $row['log_password'];  ?>">
                                        </td>
                                        <td><?php  echo $row['log_fname']; ?></td>
                                        <td><?php  echo $row['log_lname']; ?></td>
                                        <td><?php  echo $row['log_type']; ?></td>
                                        <td align="center">
                                        	<a href="edite_login.php? id=<?php  echo $row['id_login'];  ?>" style="padding-right: 10px;"><img src="images/edit.png" alt="edit" height="20" width="20"></a>
                                        	<a onclick="return  confirm('คุณต้องการลบข้อมูลใช่หรือไม่ !!!')" href="delete_login.php? id=<?php  echo $row['id_login'];  ?>"><img src="images/delete.png" alt="delete" height="20" width="20"></a>
                                    	</td>
