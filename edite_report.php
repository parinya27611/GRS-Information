...
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			$sql = "select * FROM tb_report where id_report = $id_report";
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<?php
						...
						{
					?>
						<form role="form" action="tb_report.php" method="POST">
							<div class="panel-heading">
								tb_report
							</div>
							<div class="panel-body">
		                        <div class="form-group">
									<label>email (อีเมลของผู้ส่ง)</label>
									<input class="form-control" name="log_email" 
									value="<?php  echo $row['re_email'];  ?>" readonly>
								</div>
								<div class="form-group">
									<label>text (ข้อความ)</label>
									<textarea  name="Detal" class="form-control" rows="5" readonly><?php  echo $row['re_text']; ?></textarea>
								</div>
