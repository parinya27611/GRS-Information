			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<?php
						...
						{
					?>
						<form role="form" action="edite_aboutabo_check.php? id=<?php  echo $row['id_about'];  ?>" method="POST">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<textarea  name="abo_textabo" class="form-control" rows="5"><?php  echo $row['abo_text'];  ?></textarea>
								</div>
